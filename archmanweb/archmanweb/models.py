...
from .utils import reverse_man_url, mandoc_convert, preprocess, postprocess, extract_description
...
class ManPage(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=('name', 'lang', 'section')),
            models.Index(fields=('section', 'name', 'lang')),
            models.Index(fields=('lang', 'name', 'section')),
            ...
            # for search
            GinIndex(name="manpage_name", fields=["name"], opclasses=["gin_trgm_ops"]),
        ]
    ...
    def eliminate_all_so_links(self, *, visited_ids=None, level=0):
        """
        ...
        def repl(match):
            ...
            return man.eliminate_all_so_links(visited_ids=visited_ids | {self.id}, level=level + 1)
    ...
    def get_converted(self, output_type):
        ...
        if content is None:
            content = self.eliminate_all_so_links()
            content = preprocess(content, output_type)
...
class SymbolicLink(models.Model):
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=('from_section', 'from_name')),
            models.Index(fields=('from_section', 'from_name', 'lang')),
            # for checks in try_symlink_or_404
            models.Index(fields=('from_name', 'lang')),
            # for search
            GinIndex(name="symboliclink_from_name", fields=["from_name"], opclasses=["gin_trgm_ops"]),
        ]
